...
<body onbeforeprint="printMsg()">
    <div class="main">
        ...
        <div class="card">
            <div class="card-body">
                <a class="btn btn-primary btn-left" href="editTeacher.php?oid=<?php echo $data['oid'] ?>">Edit</a> <a class="btn btn-danger btn-left" href="../controller/deleteTeacher.php?o-id=<?php echo $data['oid'] ?>">Delete</a><a class="btn btn-secondary btn-left" onclick="window.print()">Print</a></td>
