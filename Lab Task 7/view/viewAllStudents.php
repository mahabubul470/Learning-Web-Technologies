    ...
    <table class="table table-hover">
      ...
      <tbody>
        <?php if (isset($students)) foreach ($students as $i => $student) : ?>
          <tr>
            <td><a style="color:black" href="viewStudent.php?oid=<?php echo $student['oid'] ?>"><?php echo $student['oid'] ?></a></td>
            ...
            <td><a class="btn btn-primary" href="editStudent.php?oid=<?php echo $student['oid'] ?>">Edit</a>&nbsp<a class="btn btn-danger" href="../controller/deleteStudent.php?oid=<?php echo $student['oid'] ?>">Delete</a></td>
          </tr>
        <?php endforeach; ?>
      </tbody>
    </table>
