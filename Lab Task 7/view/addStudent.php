...
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" class="form">
  <div class="container-fluid add-frm">
    ...
    <div class="mb-3">
      ...
      <sup style="color: red;">*</sup>
      <input name="re-password" type="password" class="form-control" id="inputPassword2" placeholder="Retype Password">
    ...
    <div class="mb-3">
      ...
      <input class="form-control" type="text" name="oid" onfocus="idFocusFunction()" onblur="idAlert()">
